...
export default {
  ...
  score: {
    ...
    macSetupStep1Prefix: 'Open the ',
    macSetupStep1App: 'Audio MIDI Setup',
    macSetupStep1Suffix: ' app (Spotlight: “Audio MIDI”)',
    macSetupStep2Prefix: 'Go to ',
    macSetupStep2Menu: 'Window → Show MIDI Studio',
    macSetupStep3Prefix: 'Click the ',
    macSetupStep3Bt: 'Bluetooth',
    macSetupStep4Prefix: 'Find your piano in the list and click ',
    macSetupStep4Connect: 'Connect',
    ...
    windowsStep1Suffix: ' (to receive the Bluetooth MIDI signal)',
    windowsStep2App: 'loopMIDI',
    windowsStep2Suffix: ' (to create a virtual MIDI port)',
