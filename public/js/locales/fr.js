...
export default {
  ...
  score: {
    ...
    macSetupStep1Prefix: "Ouvrez l'application ",
    macSetupStep1App: 'Audio MIDI Setup',
    macSetupStep1Suffix: ' (Spotlight : « Audio MIDI »)',
    macSetupStep2Prefix: 'Allez dans ',
    macSetupStep2Menu: 'Fenêtre → Afficher le studio MIDI',
    macSetupStep3Prefix: "Cliquez sur l'icône ",
    macSetupStep3Bt: 'Bluetooth',
    macSetupStep4Prefix: 'Repérez votre piano dans la liste et cliquez sur ',
    macSetupStep4Connect: 'Connecter',
    ...
    windowsStep1App: 'BLE MIDI Bridge',
    windowsStep1Suffix: ' (pour recevoir le signal Bluetooth MIDI)',
    windowsStep2App: 'loopMIDI',
    windowsStep2Suffix: ' (pour créer un port MIDI virtuel)',
